function [sol,dif,res,iter,ACOC] = SOR1(A,b,opts)

%SOR1 Iteratively solves Ax=b using a formulation for the SOR method
% Works for complex, positively defined or strictly diagonal matrices
%
%   sol = Jacobi(A,b)

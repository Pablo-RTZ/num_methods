function [sol, dif, iter, ACOC] = Steffensen(f, opts)

%Steffensen Steffensen's method for solving nonlinear equations.
% Uses function handles, and uses step size as stopping criterion.
% This is a secant-like method that does not require derivatives.
%
%   sol = Steffensen(f)
%   Uses 0 as initial guess, a 1e-10 tolerance, and 50 iterations by
%   default
%
%   sol = Steffensen(f, "x0", 1, "tol", 1e-8, "maxiter", 100)
